      ...
      <Row gutter={[16, 16]}>
        ...
        <Col span={8}>
          <Card className="shadow-sm">
            ...
            />
            <div className="mt-4">
              <div className="h-20 bg-blue-100 rounded-md flex items-center justify-center">
                <p className="text-blue-500">Graph Placeholder</p>
              </div>
            </div>
          </Card>
        </Col>
...
<Col span={8}>
      ...
      >
        {orders.map((order, index) => (
          ...
          >
            <div>
              <span className="block text-lg font-semibold">{order.id}</span>
